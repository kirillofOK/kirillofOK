...
Мои обязанности: 
- Администрация сервера на базе Linux 
- Написание дешифровщика сигналов воздушного судна (C++) 
- Проектировка базы данных 
- Написание REST для получения данных, отправлямые точками приема сигнала.
